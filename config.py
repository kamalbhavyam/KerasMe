...
def load_parameters():
    ...
    INPUT_VOCABULARY_SIZE = 35000                     # Size of the input vocabulary. Set to 0 for using all,
    ...
    MAX_INPUT_TEXT_LEN = 35                       # Maximum length of the input sequence.

    # Output text parameters
    OUTPUT_VOCABULARY_SIZE = 35000                    # Size of the input vocabulary. Set to 0 for using all,
                                                  # otherwise it will be truncated to these most frequent words.
    MIN_OCCURRENCES_OUTPUT_VOCAB = 0              # Minimum number of occurrences allowed for the words in the output vocabulary.
    MAX_OUTPUT_TEXT_LEN = 35                      # Maximum length of the output sequence.
